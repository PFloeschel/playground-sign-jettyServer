...
public class SignProcessor implements Processor {
    ...
    private static final Properties PROPERTIES = Configuration.load("signProcessor");
...
//
            ...
            ks.load(new FileInputStream(PROPERTIES.getProperty("certificatePath") + certificate + PROPERTIES.getProperty("certificateExtension")), pin);
            ...
            if (level == PAdES.B_T || level == PAdES.B_LT || level == PAdES.B_LTA) {
                tsaClient = new TSAClientBouncyCastle(PROPERTIES.getProperty("tsaUri"));
            }
